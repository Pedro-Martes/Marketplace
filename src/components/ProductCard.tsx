    ...
    return (
        <TouchableOpacity {...rest} onPress={handleProduct}>
            ...
            <VStack mt={8} w={ImagemWidth} mr={3}  >
                ...
                <Text color={'white'}  zIndex={2} m={1} position={'absolute'} display={!data.is_active ? 'flex' : 'none'} fontWeight={'bold'} mt={35} >Anúncio desativado</Text>
                <View w={'100%'} h={100}  rounded={'lg'} background={'gray.700'} opacity={0.5} position={'absolute'} zIndex={1} display={!data.is_active ? 'flex' : 'none'} >
