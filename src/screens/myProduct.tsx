...
export function MyProduct() {
    ...
    //             <HStack background={product?.is_active ? 'gray.700' : 'blue.primary'} alignItems={'center'} justifyContent={'center'} p={1} borderRadius={6} w={'100%'}   >

    //                 <Power weight="regular" color="#ffff" />
    //                 <Button display={'flex'} mt={0} type={product?.is_active ? 'black' : 'blue'} >
